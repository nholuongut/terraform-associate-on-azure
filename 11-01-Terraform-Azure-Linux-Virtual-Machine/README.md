...
write_files:
  - owner: root:root 
    ...
    content: |
      <h1>Welcome to Nho Luong DevOps Blogs - APP-1</h1>
  - owner: root:root 
    path: /var/www/html/app1/index.html
    content: |
      <!DOCTYPE html> <html> <body style="background-color:rgb(250, 210, 210);"> <h1>Welcome to Nho Luong DevOps Blogs - APP-1</h1> <p>Terraform Demo</p> <p>Application Version: V1</p> </body></html>      
runcmd:
