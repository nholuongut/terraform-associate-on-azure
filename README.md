...
## What will demos code in this repositories?
- You will learn to master Terraform in a practical perspective
...
## Are there any Demos requirements or prerequisites?
- You must have an Azure Cloud account to follow with me for hands-on activities.
- You don't need to have any basic knowledge of Terraform. Demos will get started from very very basics of Terraform and take you to very advanced levels

## Github Repositories used for this Demos
- [HashiCorp Certified: Terraform Associate on Azure](https://github.com/nholuongut/terraform-associate-on-azure)
...
- [Terraform Sentinel Policies](https://github.com/nholuongut/terraform-sentinel-policies-azure)
- [Presentation with PPt FIle](/NhoLuong-Presentation/~$Terraform-Associate-on-Azure.pptx)
...
- "No Questions Asked" Money Back Guarantee after done!
